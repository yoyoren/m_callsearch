...
if ($_REQUEST['act'] == '')
{
	...
	$smarty->display('order_stat2.html');
}
elseif ($_REQUEST['act'] == 'top')
{

    $smarty->display('stat_top2.html');
}
...
elseif ($_REQUEST['act'] == 'list')
{
	...
	//echo $str;
	$smarty->display('order_stat_list2.html');
}
...
function order_list()
{
	...
	$filter['pay_id']   = empty($_REQUEST['pay_id'])   ? '' : intval($_REQUEST['pay_id']);	
