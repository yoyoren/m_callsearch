...
<div class="main">
	<table id=theObjTable STYLE="table-layout:fixed" cellspacing=1 cellpadding=1 bgcolor=#bab196 border=0>
		<tr bgcolor=#CCCCFF>
			...
			<td valign=top style="overflow: hidden; text-overflow:ellipsis" width=70>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				订单状态
			</td>
			...
			<td align=center valign=top style="overflow: hidden; text-overflow:ellipsis" width=40>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				序号
			</td>
			<td align=center valign=top style="overflow: hidden; text-overflow:ellipsis" width=100>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				订单号
			</td>
			<td align=center valign=top style="overflow: hidden; text-overflow:ellipsis" width=90>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				送货时间
			</td>
			<td valign=top style="overflow: hidden; text-overflow:ellipsis" width=30>
			...
			<td align=center valign=top style="overflow: hidden; text-overflow:ellipsis" width=350>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				送货地址
			</td>
			<td valign=top style="overflow: hidden; text-overflow:ellipsis" width=65>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				订货人
			</td>
			<td align=center valign=top style="overflow: hidden; text-overflow:ellipsis" width=80>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				电话
			</td>
			...
			<td valign=top style="overflow: hidden; text-overflow:ellipsis" width=160>
				<font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font>
				送货人及电话
			</td>
...
?>
			<tr bgcolor=#FFFFFF onMouseOver="this.style.backgroundColor='#FFCCCC'" onMouseOut="this.style.backgroundColor=''">
				<td align=center width="30" bgcolor=#FFFF66><a href='http://www.mescake.com/mescall/order.php?act=detail&order_id=<?php echo $this->_var['list']['order_id']; ?>' target='_blank'>详情</a></td>
				...
				<td align=center><?php echo $this->_var['list']['best_time']; ?></td>
				...
				<td><?php echo $this->_var['list']['sender']; ?>|<?php echo $this->_var['list']['sendertel']; ?></td>
				<td><?php echo $this->_var['list']['add_time']; ?></td>
				<td align=center width="30" bgcolor=#FFFF66><a href='http://www.mescake.com/mescall/order.php?act=show&order_id=<?php echo $this->_var['list']['order_id']; ?>' target="_blank">详情</a></td>
			</tr>
	...
	<table><tr><td>共计 <span id="totalRecords"><?php echo $this->_var['record_count']; ?></span>
        ...
        页，每页10条，
        <span id="page-link">
          <a href="order_bstat.php?act=list&page=1<?php echo $this->_var['querystr']; ?>">第一页</a>
          <a href="order_bstat.php?act=list&page=<?php echo $this->_var['pagef']; ?><?php echo $this->_var['querystr']; ?>">上一页</a>
          <a href="order_bstat.php?act=list&page=<?php echo $this->_var['pagen']; ?><?php echo $this->_var['querystr']; ?>">下一页</a>
          <a href="order_bstat.php?act=list&page=<?php echo $this->_var['page_count']; ?><?php echo $this->_var['querystr']; ?>">最末页</a>
        </span></td></tr></table>
</div>
</body>
</html>
