...
?>
	...
	<table><tr><td>共计 <span id="totalRecords"><?php echo $this->_var['record_count']; ?></span>
        ...
        页，每页10条，
        <span id="page-link">
          <a href="order_stat.php?act=list&page=1<?php echo $this->_var['querystr']; ?>">第一页</a>
          <a href="order_stat.php?act=list&page=<?php echo $this->_var['pagef']; ?><?php echo $this->_var['querystr']; ?>">上一页</a>
          <a href="order_stat.php?act=list&page=<?php echo $this->_var['pagen']; ?><?php echo $this->_var['querystr']; ?>">下一页</a>
          <a href="order_stat.php?act=list&page=<?php echo $this->_var['page_count']; ?><?php echo $this->_var['querystr']; ?>">最末页</a>
        </span></td></tr></table>
</div>
</body>
</html>
