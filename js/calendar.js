...
strFrame+='	   <tr><td style="font-size:12px;color:#ffffff;background-color:#CC0000;" width=20>&nbsp;日</td>';
...
strFrame+='<td style="font-size:12px;color:#FFFFFF" >&nbsp;五</td><td style="font-size:12px;color:#FFFFFF;background-color:#CC0000;" >&nbsp;六</td></tr>';
strFrame+='</table></td></tr>';
...
strFrame+= ' <tr align=center >'; 
     for (i=0;i<7;i++)
	 {
        if(i==0||i==6)
		{
		strFrame+='<td width=20 bgcolor=#FF0000 height=20 id=meizzDay'+n+' style="font-size:12px;" onclick=parent.meizzDayClick(this.innerText,0)></td>';	
		}
		else
		{
