...
if ($_REQUEST['act'] == '')
{
	...
	$smarty->display('order_stat.html');
}
elseif ($_REQUEST['act'] == 'top')
{

    $smarty->display('stat_top.html');
}
...
elseif ($_REQUEST['act'] == 'list')
{
	...
	$smarty->display('order_stat_list.html');
}
...
function order_list()
{
    ...
    $sql = "SELECT COUNT(*) FROM order_genid AS b left join ecs_order_info as a on a.order_id=b.order_id ".
	       "left join print_log_x as c on a.order_id=c.order_id ". $where;
